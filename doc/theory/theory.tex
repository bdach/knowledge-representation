...
\subsection{Semantyka języka}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item $\Possibly \gamma \After A_1, \dots, A_n$ -- wówczas $\mathcal{D} \; |\!\!\!\approx \mathcal{Q}$ wtedy i tylko wtedy, gdy dla każdego modelu % TODO: do uzgodnienia
            ...
            \item $\Necessary \gamma \After A_1, \dots, A_n$ -- wówczas $\mathcal{D} \; |\!\!\!\approx \mathcal{Q}$ wtedy i tylko wtedy, gdy dla każdego modelu % TODO: do uzgodnienia
        ...
        \begin{itemize}
            \item $\Executable A_1, \dots, A_n$ -- wówczas $\mathcal{D} \; |\!\!\!\!\approx \mathcal{Q}$ wtedy i tylko wtedy, gdy istnieje model % TODO: do uzgodnienia
            ...
            \item $\Executable \Always A_1, \dots, A_n$ -- wówczas $\mathcal{D} \; |\!\!\!\!\!\approx \mathcal{Q}$ wtedy i tylko wtedy, gdy dla każdego modelu % TODO: do uzgodnienia
