...
\begin{defn}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item $\Executable A_1, \dots, A_n$ -- wówczas $\mathcal{D} \consequence \mathcal{Q}$ wtedy i tylko wtedy, gdy dla~każdego modelu % TODO: do uzgodnienia
...
\begin{itemize}
    ...
    \begin{align*}
		...
		Res_0(\sigma_0, \{\textsc{TakeA, TakeB} \}, \sigma_0 \}) &= \{ \sigma_1, \sigma_2 \} \\  
		...
		Res_0(\sigma_0, \{\textsc{TakeA, TakeB, Paint} \}, \sigma_0 \}) &= \{ \sigma_1, \sigma_2 \} \\         
    ...
    \begin{align*}
%    	Res_0(\sigma_1, \{ \textsc{TakeA} \}) &= \{ \sigma_1, \sigma_3 \} \\
%        New(\{ \textsc{TakeA} \}, \sigma_0, \sigma_1) &=  \{ \textit{brushA} \} \\    
%        New(\{ \textsc{TakeA} \}, \sigma_0, \sigma_3) &=  \{ \textit{brushA}, \textit{brushB} \} \\    
%        Res(\sigma_1, \{ \textsc{TakeA} \}) &= \{ \sigma_1 \} \\
		...
		Res_0(\sigma_1, \{\textsc{TakeA, TakeB} \}, \sigma_1 \}) &= \{ \sigma_1, \sigma_2 \} \\  
    	...
    	Res_0(\sigma_1, \Delta_2(\{\textsc{TakeA, Paint} \}, \sigma_1 \})) &= Res_0(\sigma_1, \{ \textsc{Paint} \}) = \{ \sigma_0 \} \\
		Res_0(\sigma_1, \{\textsc{TakeA, Paint} \}, \sigma_1 \}) &= \{ \sigma_0, \sigma_1 \} \\  
    	...
    	Res_0(\sigma_1, \Delta_2(\{\textsc{TakeA, Paint} \}, \sigma_1 \})) &= Res_0(\sigma_1, \{ \textsc{TakeB, Paint} \}) = \{ \sigma_2 \} \\
		Res_0(\sigma_1, \{\textsc{TakeA, Paint} \}, \sigma_1 \}) &= \{ \sigma_1, \sigma_2 \} \\  
        New(\{ \textsc{TakeA, Paint} \}, \sigma_1, \sigma_1) &= \emptyset \\    
